Benjamin James DeAcetis

How to compile and run the program:
1. To compile and run, navigate to the directory in the terminal in which the files are stored (using cd commands).
2. Assuming you are in the correct directory, to compile type in "javac FractalDrawer.java".
3. To run the program, type in "java FractalDrawer".

Outside sources:
– Isosceles triangle perimeter formula: Google.com: 
